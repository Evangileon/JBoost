...
public class Controller implements Runnable{
  ...
  private BoostByteBuffer dataPool;
  ...
  public static void main(String[] argv) {
    ...
    try {
      ...
      controller.m_trainStream.finalize();
      controller.m_monitor.finalize();
      controller.m_trainSet = null;
      System.gc();
  ...
  public void init() throws Exception {
    ...
    dataPool = new BoostByteBuffer(m_exampleDescription.getNoOfAttributes(), 10);
  ...
  public void outputLearningResults() throws Exception {
    // output final result
    reportResults();
    System.out.println("reportResults done");
    WritablePredictor res = m_learningTree.getCombinedPredictor();
    System.out.println("getCombinedPredictor done");
    ...
    if (cFile != null) {
    	System.out.println("start generateCode");
  ...
  private void learn(int iterNo) throws NotSupportedException, InstrumentException {
    ...
    System.out.println("Finish learning loop");
  }
  ...
  private void readTrainData() throws IncompAttException, ParseException {
    ...
    int rejected = 0;
    start = System.currentTimeMillis();
    System.out.println("start readTrainData");
    double threshold = m_config.getDouble(Configuration.SAMPLE_THRESHOLD_WEIGHT, 0);

    while ((example = m_trainStream.getExample(this.dataPool)) != null) {
  ...
  private void startTokenizer() throws Exception {
    DataStream ds = null;
    System.out.println("startTokenizer myself");
    String spec = m_config.getSpecFileName();
    String train = m_config.getTrainFileName();
    System.out.println("get spec and train");
    ds = new jboost_DataStream(spec, train);
    m_trainStream = new ExampleStream(ds);
    System.out.println("trainStream read");
