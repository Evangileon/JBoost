...
public class Configuration {
	...
	private HashMap<String,String> m_parsedCommands;
	private Vector<String> m_validCommands;
	...
	public Configuration() {
		m_parsedCommands = new HashMap<String,String>(20);
		m_validCommands = new Vector<String>(20);
	...
	public void printUsage() {
		...
		Monitor.log(m_usage,Monitor.LOG_LEVEL_THREE);
	}

	/** Print out all parsed commands that this configuration currently contains. */
	public String toString() {
		String retval = new String();
		Set<String> commands = m_parsedCommands.keySet();
	...
	public int getInt(String name, int def) {
		...
		if (m_parsedCommands.containsKey(name)) {
			try {
				...
				Monitor.log("Error Parsing Option: " + v,Monitor.LOG_LEVEL_THREE);
			}
		}
		else {
			m_unSpecified += name + ",";
	...
	public boolean getBool(String name, boolean def) {
		...
		if (m_parsedCommands.containsKey(name)) {
			...
			if (v.equals("+") || v.equalsIgnoreCase("true") || v.equals("")) {
				...
				Monitor.log("Inappropriate command argument " + v + " received with option " + name,Monitor.LOG_LEVEL_THREE);
			}
		}
		else {
			m_unSpecified += name + ",";
	...
	public static final String BROWNBOOST_TIME = "bb_t";
	public static final String BROWNBOOST_EPSILON = "bb_epsilon";
	public static final String BROWNBOOST_THETA = "bb_theta";
	public static final String BROWNBOOST_THETA_0 = "bb_theta_0";
	public static final String BROWNBOOST_THETA_1 = "bb_theta_1";
	public static final String BROWNBOOST_COST_0 = "bb_cost_0";
	public static final String BROWNBOOST_COST_1 = "bb_cost_1";
	...
	protected boolean checkCommandValues() throws BadCommandException {
		...
		try {
			...
			Monitor.log("Spec: " + specname + ", Test: " + testname + ", Train: " + trainname,Monitor.LOG_LEVEL_ALWAYS);
