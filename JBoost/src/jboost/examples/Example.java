...
public class Example {
   ...
   * @param ed
   */
  public Example(BoostByteBuffer datapool, Attribute[] attArray, int index, Label label, double weight, ExampleDescription ed, int exaIndex) {
	  System.out.println("index = " + exaIndex);
	  m_instance = new Instance(datapool, attArray, exaIndex);
	  m_label = label;
	  m_weight = weight;
	  m_index = index;
	  m_exampleDescription = ed;
  ...
  public Example(Instance instance, int index, Label label, double weight, ExampleDescription ed) {
	  m_instance = instance;
	  m_label = label;
	  m_weight = weight;
	  m_index = index;
...
//  public Example(BoostByteBuffer dataPool, int index, Label label, double weight, ExampleDescription ed) {
//	  m_instance = new Instance(attArray);
//	  m_label = label;
//	  m_weight = weight;
//	  m_index = index;
...
//  }
  ...
  public Attribute getAttribute(int i) {
    return m_instance.getAttribute(i);
  }
