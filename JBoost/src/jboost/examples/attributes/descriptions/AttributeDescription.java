...
public abstract class AttributeDescription implements Serializable {
  ...
  /**
	 * 
	 */
	private static final long serialVersionUID = -2077493061467853020L;
...
/**
  ...
  public static AttributeDescription build(String name, String type, Configuration options, List<String> okValues) throws ClassNotFoundException, BadLabelException {
