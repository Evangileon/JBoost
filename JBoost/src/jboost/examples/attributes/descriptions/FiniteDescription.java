...
class FiniteDescription extends AttributeDescription {
  ...
  /**
	 * 
	 */
	private static final long serialVersionUID = 3758322359948314048L;
FiniteDescription(String name, Configuration c, List<String> okValues) throws ClassNotFoundException {
    map = new HashMap<String,Integer>();
    attributeName = name;
    attributeClass = Class.forName("jboost.examples.attributes.DiscreteAttribute");
    ;
  ...
  public void setAttributeValues(Vector<String> values) {
  ...
  protected Vector<String> attributeValues;
