...
class StringDescription extends AttributeDescription {
  ...
  /**
	 * 
	 */
	private static final long serialVersionUID = -3024984417160028697L;

StringDescription(String name, Configuration c) throws ClassNotFoundException {
    attributeName = name;
    attributeClass = Class.forName("jboost.examples.attributes.RealAttribute");
  ...
  private HashMap<String, Integer> map = new HashMap<String,Integer>(); // mapping from string to int
