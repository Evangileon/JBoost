...
public class ExampleStream {
  ...
  public Example getExample(BoostByteBuffer dataPool) throws ParseException {
	    ...
	    while (retval == null) {
	      try {
	        ...
	        retval = parseExampleText(exaText, dataPool);
	        exaText = null;
	      }
	      catch (BadExaException e) { // bad example
	    ...
	    System.gc();
	    System.out.println("get an example");
	    return (retval);
	  }
  ...
  public Example parseExampleText(String[] exaText, BoostByteBuffer dataPool) throws BadExaException {
	  Monitor.log("ExampleStream.parseExampleText Parsing Example:",Monitor.LOG_LEVEL_THREE);
	    ...
	    exaIndex++;
	    return new Example(dataPool, attArray, index, label, weight, ds.ed, exaIndex);
  }

  public Example parseExampleText(Attribute[] attArray, int index, Label label, double weight, ExampleDescription ed) {
  ...
  public Example parseExampleText(String[] exaText) throws BadExaException {
    ...
    return parseExampleText(attArray, index, label, weight, ds.ed);
  }
  
//  private Attribute[] getAttributesArray(String[] exaText) {
//	  int numAtt = ds.ed.getNoOfAttributes();
//	    Attribute[] attArray = new Attribute[numAtt];
//	    Label label = null;
//	    double weight = 1.0;
