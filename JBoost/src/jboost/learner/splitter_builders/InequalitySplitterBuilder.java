 ...
 */
public class InequalitySplitterBuilder extends SplitterBuilder {

  /** Default constructor */
  public InequalitySplitterBuilder() {
   ...
   */
  public InequalitySplitterBuilder(int attributeIndex, double[] indexedValues, int[] sortedIndices, boolean[] potentialSplits, boolean[] examplesMask,
   ...
   */
  public InequalitySplitterBuilder(int index, Booster booster, AttributeDescription[] ad) {
    isRoot = true;
    isFinalized = false;
    attributeIndex = index;
    this.booster = booster;
    tempList = new ArrayList<IVL>();
    largestIndex = -1;
    desc = ad;
    m_type = SplitterType.INEQUALITY_SPLITTER;
  }
  ...
  class IVL implements Comparable<Object> {
