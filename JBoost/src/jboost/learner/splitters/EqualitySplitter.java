...
/**
 * Splits examples according to whether a {@link jboost.examples.attributes.RealAttribute}
 * is equal to a fixed value. If it is equal, returns 0 or -1 if unknown or 1 if
 * not equal and split is binary.
 */
public class EqualitySplitter extends Splitter {

  /**
	 * 
	 */
	private static final long serialVersionUID = 3966205013149576674L;
private int value;
