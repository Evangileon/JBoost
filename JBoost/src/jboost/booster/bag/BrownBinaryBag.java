 ...
 */
public class BrownBinaryBag extends BinaryBag {

	/** default constructor */
	public BrownBinaryBag(BrownBoost robustBoost) {
		super(robustBoost);
	}

	/** constructor that copies an existing bag */
	public BrownBinaryBag(BinaryBag bag,BrownBoost robustBoost) {
		super(bag,robustBoost);
	}

	/** a constructor that initializes a bag the given list of examples */
	public BrownBinaryBag(int[] list,BrownBoost robustBoost) {
