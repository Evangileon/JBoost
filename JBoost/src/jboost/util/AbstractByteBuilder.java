...
public abstract class AbstractByteBuilder implements Appendable, CharSequence {
    /**
    ...
    /** 
     * Creates an AbstractByteBuilder of the specified capacity.
     */
    AbstractByteBuilder(int capacity) {
...
//    }
	...
	public AbstractByteBuilder append(String str) {
    ...
    public AbstractByteBuilder append(ByteBuffer sb) {
	if (sb == null)
            return append("null");
	int len = sb.length();
	int newCount = count + len;
    ...
    // Documentation in subclasses because of synchro difference
    public AbstractByteBuilder append(CharSequence s) {
        if (s == null)
            s = "null";
     ...
     */
    public AbstractByteBuilder append(CharSequence s, int start, int end) {
        if (s == null)
            s = "null";
     ...
     * @return  a reference to this object.
     */
    public AbstractByteBuilder append(byte str[]) { 
     ...
     * @return  a reference to this object.
     */
    public AbstractByteBuilder append(byte str[], int offset, int len) {
        int newCount = count + len;
	if (newCount > value.length)
	    expandCapacity(newCount);
     ...
     * @return  a reference to this object.
     */
    public AbstractByteBuilder append(boolean b) {
        if (b) {
     ...
     * @return  a reference to this object.
     */
    public AbstractByteBuilder append(byte c) {
     ...
     * @return  a reference to this object.
     */
//    public AbstractByteBuilder append(int i) {
...
//    }
     ...
     * @return  a reference to this object.
     */
//    public AbstractByteBuilder append(long l) {
//        if (l == Long.MIN_VALUE) {
...
//    }
     ...
     */
    @Deprecated
    public AbstractByteBuilder append(float f) {
    	long bits = Double.doubleToLongBits(f);
    	byte[] tmp = new byte[4];
    	for(int i = 0; i < 8; i++) {
    		tmp[i] = (byte)((bits >> (i * 8)) & 0xff);
    	}
    	this.append(tmp);	
    	return this;
    }
     ...
     * @return  a reference to this object.
     */
    public AbstractByteBuilder append(double d) {
    	this.append(double2Bytes(d));	
    	return this;
    }
     ...
     */
    public AbstractByteBuilder delete(int start, int end) {
	if (start < 0)
     ...
     */
//    public AbstractByteBuilder appendCodePoint(int codePoint) {
...
//    }
     ...
     *		    <code>length()</code>.
     */
    public AbstractByteBuilder deleteCharAt(int index) {
        if ((index < 0) || (index >= count))
	    throw new StringIndexOutOfBoundsException(index);
     ...
     *		   greater than <code>end</code>.
     */ 
//    public AbstractByteBuilder replace(int start, int end, String str) {
//        if (start < 0)
//	    throw new StringIndexOutOfBoundsException(start);
//	if (start > count)
...
//    }
     ...
     */
    public AbstractByteBuilder insert(int index, byte str[], int offset,
                                        int len)
    {
     ...
     */
    public AbstractByteBuilder insert(int offset, Object obj) {
     ...
     * @throws     StringIndexOutOfBoundsException  if the offset is invalid.
     */
//    public AbstractByteBuilder insert(int offset, String str) {
...
//    }
     ...
     * @throws     StringIndexOutOfBoundsException  if the offset is invalid.
     */
    public AbstractByteBuilder insert(int offset, byte str[]) {
	if ((offset < 0) || (offset > length()))
	    throw new StringIndexOutOfBoundsException(offset);
	int len = str.length;
	int newCount = count + len;
     ...
     */
    public AbstractByteBuilder insert(int dstOffset, CharSequence s) {
        if (s == null)
            s = "null";
        if (s instanceof String)
	...
	System.arraycopy(value, dstOffset, value, dstOffset + len,
                         count - dstOffset);
	for (int i=start; i<end; i++)
            value[dstOffset++] = (byte) s.charAt(i);
	count = newCount;
        return this;
    }
     ...
     * @throws     StringIndexOutOfBoundsException  if the offset is invalid.
     */
    public AbstractByteBuilder insert(int offset, boolean b) {
     ...
     * @throws     IndexOutOfBoundsException  if the offset is invalid.
     */
    public AbstractByteBuilder insert(int offset, byte c) {
	int newCount = count + 1;
	if (newCount > value.length)
	    expandCapacity(newCount);
     ...
     * @throws     StringIndexOutOfBoundsException  if the offset is invalid.
     */
    public AbstractByteBuilder insert(int offset, int i) {
     ...
     * @throws     StringIndexOutOfBoundsException  if the offset is invalid.
     */
    public AbstractByteBuilder insert(int offset, long l) {
     ...
     * @throws     StringIndexOutOfBoundsException  if the offset is invalid.
     */
    public AbstractByteBuilder insert(int offset, float f) {
     ...
     * @throws     StringIndexOutOfBoundsException  if the offset is invalid.
     */
    public AbstractByteBuilder insert(int offset, double d) {
...
//    }
     ...
     * @return  a reference to this object.
     */
    public AbstractByteBuilder reverse() {
	boolean hasSurrogate = false;
	int n = count - 1;
	for (int j = (n-1) >> 1; j >= 0; --j) {
	    byte temp = value[j];
	    byte temp2 = value[n - j];
	    if (!hasSurrogate) {
